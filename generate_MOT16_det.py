...
if __name__ == '__main__':
    ...
    seq_path = r'E:\PyProjects\datasets\MOT16\train/{}/img1/'
    det_result_path = r'E:\PyProjects\datasets\MOT16\train\{}\det\centernet_det.txt'
    seqs = os.listdir(r'E:\PyProjects\datasets\MOT16\train')
    ...
    for sq in seqs:
        ...
        if os.path.isdir(opt.demo):
            opt.det_result_file = open(det_result_path.format(sq), 'w')
            demo(opt)
